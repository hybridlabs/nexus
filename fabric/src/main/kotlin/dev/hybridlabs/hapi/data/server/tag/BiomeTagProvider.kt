...
class BiomeTagProvider(output: FabricDataOutput, registriesFuture: CompletableFuture<HolderLookup.Provider>) :
    ...
    override fun addTags(arg: HolderLookup.Provider) {
        ...
        getOrCreateTagBuilder(BiomeTags.HAS_RUINED_PORTAL_OCEAN)
            ...
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "trench"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "lukewarm_trench"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "warm_trench"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "cold_trench"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "frozen_trench"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "tropical_deep_coral_reef"))
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "deep_coral_reef"))

        getOrCreateTagBuilder(BiomeTags.HAS_CLOSER_WATER_FOG)
            .forceAddTag(BiomeTags.IS_DEEP_OCEAN)
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "sulfuric_caves"))
        ...
        getOrCreateTagBuilder(HAPIBiomeTags.TIDE_POOLS)
            .addOptional(ResourceLocation.fromNamespaceAndPath("hybrid_aquatic", "tide_pools"))
        //#endregion
